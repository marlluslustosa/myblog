...
Continuando com as influências, no séc. XX, o  físico David Bohm introduziu o conceito de [Holomovimento](https://pt.wikipedia.org/wiki/Holomovimento) para descrever uma totalidade dinâmica e indivisível que subjaz a toda a realidade. O Holomovimento integra duas ideias cruciais: totalidade indivisível e processo constante, sustentando que tudo no universo está interconectado e em movimento contínuo.
...
Esse entendimento das ordens é crucial para o conceito de Holismo Quântico (Holografia Quântica), [o qual se refere Chengxin Pan](https://doi.org/10.1177/1354066120938844), onde as partículas são vistas como "estados quantizados de um campo que se estende a todo o espaço". O todo é irredutível às partes, e as partes só existem em relação; o todo está nas partes e as partes emergem do todo (coemergência).
...
A física e filósofa Karen Barad, com seu [Realismo Agencial](https://www.dukeupress.edu/meeting-the-universe-halfway), também propõe uma perspectiva ontológica que desafia a noção de entidades preexistentes. Para Barad, a matéria não é uma substância fixa, mas sim um "fazer", um processo de "intra-ação iterativa" que consolida a agência.
...
[Marcos Lima introduz o conceito de Avaliação Trágica ou Diferencial](https://revistacaribena.com/ojs/index.php/rccs/article/view/4789), situando-a no plano de imanência e desafiando a primazia das avaliações tradicionais, que se limitam a atribuir valores morais ou utilitários. Esta abordagem dialoga profundamente com o realismo da potencialidade e a causa imanente, já comentados em parágrafos anteriores: para ambos, a realidade fundamental não se resume às "propriedades atuais" (aquilo que já se concretizou), mas é constituída também por potencialidades intrínsecas, ou seja, propensões reais e objetivas. Outros artigos do mesmo autor incluem o "[Pentateuco - Modos vitais, epistemes, fundamentos, modelos e tecnias no ato de avaliar](https://doi.org/10.54899/dcs.v22i81.3174)" e a proposta da [Metodologia Pentapolar - Expansao e aplicação em pesquisas sobre avaliaçao](https://doi.org/10.36557/2009-3578.2025v11n2p5050-5069).
...
A sustentação dessa avaliação exige uma estrutura lógica capaz de suportar o paradoxo da contradição, papel que pode ser ocupado pela Lógica Paraconsistente. [O lógico brasileiro Newton da Costa, em colaboração com De Ronde](https://link.springer.com/article/10.1007/s10701-013-9721-9), já propôs uma leitura das superposições físicas onde a contradição é um elemento-chave da estrutura formal da teoria "desde o início". Na realidade fundamental da potência, segundo eles, propriedades contraditórias coexistem; A e não-A habitam o mesmo espaço virtual sem se anularem. [Aqui](https://marllus.com/ciencia/2025/01/20/o-uso-da-l%C3%B3gica-paraconsistente-nos-estudos-em-avalia%C3%A7%C3%A3o-educacional) eu discuto mais sobre a aplicação da lógica paraconsistente em estudos em Avaliação Educacional, se quiser mais detalhes.
